...
//If 'Del' value is set, call 'delete' function
if (isset($_GET['Del'])){
	delete($_GET['Del']);
}
...
function archiveBulk() {
	if(!empty($_POST['check'])){
		foreach ($_POST['check'] as $checkbox) {
			...
			$query = "UPDATE wp_iecrm_bookingCal SET status=3 WHERE id='".$checkbox."'";
			$result = mysqli_query($con,$query);
		}
	...
	<form action="#" method="post">
		...
		<div class="container-table100">
			<div class="wrap-table100">
				<input type="button" class = "contact100-form-btn2" value="Add New Booking" onclick="window.location.href='admin.php?page=booking-new'" style="width: 15%;">
				<div style="float: right;">
					<input type="button" class = "contact100-form-btn" value="Search" onclick="window.location.href='admin.php?page=booking-list' + inputCheck();">
				</div>
				<div style="float: right;">
				...
				<div class="table100 ver1 m-b-110">
					<table data-vertable="ver1">
						<thead>
							<tr class="row100 head">
								...
								<th class="column100 column3" data-column="column3"><a class = "orderByValue" href = "admin.php?page=booking-list&Val=id<?php echo (isset($_GET['Search']) ? "&Search=".$_GET['Search']: ''); ?>">ID</a></th>
								<th class="column100 column4" data-column="column4"><a class = "orderByValue" href = "admin.php?page=booking-list&Val=name<?php echo (isset($_GET['Search']) ? "&Search=".$_GET['Search']: ''); ?>">NAME</a></th>
								<th class="column100 column5" data-column="column5"><a class = "orderByValue" href = "admin.php?page=booking-list&Val=start_event<?php echo (isset($_GET['Search']) ? "&Search=".$_GET['Search']: ''); ?>">START DATE/TIME</a></th>
								<th class="column100 column6" data-column="column6"><a class = "orderByValue" href = "admin.php?page=booking-list&Val=addressStart<?php echo (isset($_GET['Search']) ? "&Search=".$_GET['Search']: ''); ?>">MOVING FROM</a></th>
								<th class="column100 column7" data-column="column7"><a class = "orderByValue" href = "admin.php?page=booking-list&Val=addressEnd<?php echo (isset($_GET['Search']) ? "&Search=".$_GET['Search']: ''); ?>">MOVING TO</a></th>
								<th class="column100 column8" data-column="column8"><a class = "orderByValue" href = "admin.php?page=booking-list&Val=status<?php echo (isset($_GET['Search']) ? "&Search=".$_GET['Search']: ''); ?>">STATUS</a></th>
						...
						foreach ( $result as $print ) {  
							...
							<tbody>
								<tr class="row100">
									...
									<td class="column100 column9" data-column="column9"><input type="button" class = "contact100-form-btn" value="View/Edit" onclick="window.location.href='admin.php?page=booking-list&Edit=<?php echo $print->id; ?>'"></td>
								</tr>
					...
					<div style="float: right;">
						<input type="button" class = "contact100-form-btn" value="Back" onclick="window.location.href='admin.php?page=booking-list<?php echo (isset($_GET['Val']) ? "&Val=".$_GET['Val']: ''); ?><?php echo (isset($_GET['Search']) ? "&Search=".$_GET['Search']: ''); ?>&Asc=<?php echo (isset($_GET['Asc']) && $_GET['Asc'] > 0 ? $_GET['Asc'] - 10: 0); ?>'" style="width: 100px;">
						<input type="button" class = "contact100-form-btn" value="Next" onclick="window.location.href='admin.php?page=booking-list<?php echo (isset($_GET['Val']) ? "&Val=".$_GET['Val']: ''); ?><?php echo (isset($_GET['Search']) ? "&Search=".$_GET['Search']: ''); ?>&Asc=<?php echo (isset($_GET['Asc']) && $_GET['Asc'] > 0 ? $_GET['Asc'] + 10: 10); ?>'" style="width: 100px;">
					</div>
				</div>
			</div>
		</form>
